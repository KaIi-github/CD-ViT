...
''' Load train set '''
data_dict = loadmat(lp_4_dataset + "LP4.mat")
...
np.save(lp_4_dataset + 'X_train.npy', X_train)
np.save(lp_4_dataset + 'y_train.npy', y_train)
np.save(lp_4_dataset + 'X_test.npy', X_test)
np.save(lp_4_dataset + 'y_test.npy', y_test)
