...
''' Load train set '''
data_dict = loadmat(lp_5_dataset + "LP5.mat")
...
np.save(lp_5_dataset + 'X_train.npy', X_train)
np.save(lp_5_dataset + 'y_train.npy', y_train)
np.save(lp_5_dataset + 'X_test.npy', X_test)
np.save(lp_5_dataset + 'y_test.npy', y_test)
